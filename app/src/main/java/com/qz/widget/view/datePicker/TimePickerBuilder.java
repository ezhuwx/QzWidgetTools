...
public class TimePickerBuilder {
    ...
    private PickerMinIntvOptions mPickerOptions;

    //Required
    public TimePickerBuilder(Context context, OnTimeSelectListener listener) {
        mPickerOptions = new PickerMinIntvOptions(PickerMinIntvOptions.TYPE_PICKER_TIME);
     ...
     */
    public TimePickerBuilder setMinuteInterval(int minuteInterval) {
