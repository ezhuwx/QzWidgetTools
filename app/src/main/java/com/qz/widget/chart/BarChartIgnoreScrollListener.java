...
/**
 * @author : ezhuwx
 * Describe : 柱状图忽略滚动触摸监听器
 * 用于解决横向柱状图，竖向嵌套滚动时，容易误触发点击事件的问题
 * Designed on 2026/07/01
 * E-mail : ezhuwx@163.com
 * Update on 16:07 by ezhuwx
 */
public class BarChartIgnoreScrollListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<?
     ...
     */
    public BarChartIgnoreScrollListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends
